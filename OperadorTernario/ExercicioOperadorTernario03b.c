...
int main()
{
   ...
   //0.1 que é 10%
   //poderia ser assim: total_compra = total_compra - (0.1 * total_compra)
   //logo total_compra sera o valor atual de compra menos 10% de total_compra(0.1 * total_compra)

   double valor_final = (tem_desconto) ? (total_compra = total_compra - (0.1 * total_compra)) : total_compra;
